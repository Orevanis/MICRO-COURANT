...
describe('End-to-End Energy Lifecycle', () => {
  ...
  it('should register a new household', async () => {
    const response = await fetch('http://localhost:3000/api/v1/identity/register', {
      method: 'POST',
      headers: {
  ...
  it('should register a new energy meter', async () => {
    const response = await fetch('http://localhost:3000/api/v1/telemetry/meter/register', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${authToken}`
  ...
  it('should ingest meter reading', async () => {
    ...
    const response = await fetch('http://localhost:3000/api/v1/telemetry/ingest', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${authToken}`
  ...
  it('should process billing for consumption', async () => {
    ...
    const response = await fetch(`http://localhost:3000/api/v1/billing/balance/${householdId}`, {
      headers: {
        'Authorization': `Bearer ${authToken}`
      }
    });
  ...
  it('should allow balance recharge', async () => {
    const response = await fetch('http://localhost:3000/api/v1/billing/recharge', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${authToken}`
  ...
  it('should create settlement for payment', async () => {
    const response = await fetch('http://localhost:3000/api/v1/settlement/create', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${authToken}`
...
describe('P2P Energy Trading Scenario', () => {
  ...
  it('should settle the trade', async () => {
    const response = await fetch('http://localhost:3000/api/v1/settlement/process', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${authToken}`
...
describe('Governance Voting Simulation', () => {
  ...
  it('should create governance proposal', async () => {
    const response = await fetch('http://localhost:3000/api/v1/governance/proposal', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${authToken}`
  ...
  it('should cast votes on proposal', async () => {
    ...
    for (const voter of voters) {
      const response = await fetch('http://localhost:3000/api/v1/governance/vote', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${authToken}`
  ...
  it('should finalize proposal and check outcome', async () => {
    const response = await fetch(`http://localhost:3000/api/v1/governance/finalize/${proposalId}`, {
      method: 'POST',
      headers: {
        'Authorization': `Bearer ${authToken}`
      }
