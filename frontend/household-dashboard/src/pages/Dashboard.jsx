    ...
    <div className="space-y-6">
      ...
      <div className="card">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <button className="btn-primary">View Usage History</button>
          <button className="btn-secondary">Recharge Balance</button>
          <button className="btn-secondary">Check Alerts</button>
        </div>
      </div>
      ...
      <div className="card">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between py-2">
            ...
            <p className="text-sm text-gray-500">
              {format(new Date(Date.now() - 7200000), "HH:mm")}
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-sm text-yellow-700 mt-1">
                Your balance is running low. Please recharge to avoid service
                interruption.
              </p>
            </div>
          </div>
