...
export default function Payments() {
  const payments = [
    { id: 1, household: 'HH-001', amount: 50, date: '2024-01-15', status: 'completed', method: 'Stellar' },
    { id: 2, household: 'HH-002', amount: 25, date: '2024-01-15', status: 'pending', method: 'Stellar' },
    { id: 3, household: 'HH-003', amount: 100, date: '2024-01-14', status: 'completed', method: 'Stellar' },
    { id: 4, household: 'HH-004', amount: 75, date: '2024-01-14', status: 'failed', method: 'Stellar' },
    { id: 5, household: 'HH-005', amount: 30, date: '2024-01-13', status: 'completed', method: 'Stellar' },
  ];
        ...
        <div className="card">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{totalRevenue} XLM</p>
            </div>
        ...
        <div className="card">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-yellow-600">{pendingAmount} XLM</p>
            </div>
          ...
          <tbody>
            {payments.map((payment) => (
              <tr key={payment.id} className="border-b hover:bg-gray-50">
                ...
                <td className="py-3 px-4 font-semibold">{payment.amount} XLM</td>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
            <div>
              ...
              <p className="text-sm text-gray-600">3 transactions awaiting confirmation</p>
            </div>
