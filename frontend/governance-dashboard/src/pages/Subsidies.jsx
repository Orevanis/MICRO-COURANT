...
export default function Subsidies() {
  ...
  const totalBeneficiaries = subsidies.reduce(
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <div className="flex items-center space-x-3 mb-2">
                  ...
                  <span
                    className={`px-2 py-0.5 rounded-full text-xs font-medium ${getStatusBadge(subsidy.status)}`}
                  >
                    {subsidy.status}
                  </span>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4 text-sm">
                  <div>
                    ...
                    <p className="font-medium">
                      {subsidy.allocated.toLocaleString()} XLM
                    </p>
                  </div>
                  <div>
                    <p className="text-gray-600">Distributed</p>
                    <p className="font-medium text-blue-600">
                      {subsidy.distributed.toLocaleString()} XLM
                    </p>
                  </div>
                  <div>
                ...
                <div className="mt-4">
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span className="font-medium">
                      {(
                        (subsidy.distributed / subsidy.allocated) *
                        100
                      ).toFixed(1)}
                      %
                    </span>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      ...
                      style={{
                        width: `${(subsidy.distributed / subsidy.allocated) * 100}%`,
                      }}
                    ></div>
                  </div>
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              placeholder="e.g., Summer Relief Program"
            />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
