...
export class NotificationService {
  ...
  async sendLowBalanceAlert(householdId, phoneNumber, balance) {
    const result = await this.smsService.sendLowBalanceAlert(householdId, phoneNumber, balance);
  ...
  async sendOutageAlert(householdId, phoneNumber, estimatedRestoration) {
    const result = await this.smsService.sendOutageAlert(householdId, phoneNumber, estimatedRestoration);
  ...
  async sendBillingAlert(householdId, phoneNumber, amount, dueDate) {
    const result = await this.smsService.sendBillingAlert(householdId, phoneNumber, amount, dueDate);
  ...
  async sendPaymentConfirmation(householdId, phoneNumber, amount, newBalance) {
    const result = await this.smsService.sendPaymentConfirmation(householdId, phoneNumber, amount, newBalance);
  ...
  async handleUSSDRequest(sessionId, phoneNumber, text, serviceCode) {
    const response = await this.ussdService.handleUSSDRequest(sessionId, phoneNumber, text, serviceCode);
